    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-6">
      <div className="flex w-full max-w-sm flex-col items-center gap-8">
        ...
        <button
          ...
          className="flex min-h-11 w-full items-center justify-center gap-3 rounded-lg bg-zinc-50 px-6 py-3 text-base font-medium text-zinc-900 transition-colors hover:bg-zinc-200"
        >
          <GoogleIcon />
          Sign in with Google
        </button>
